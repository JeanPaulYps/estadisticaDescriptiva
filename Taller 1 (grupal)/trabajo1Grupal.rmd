...
## Análisis variable habitos de estudio
...
## Análisis para la variable fecha_nac
...
```{r}
porcentaje <- round(t2, 1)
label <- paste(porcentaje, "%", sep="")

pie(t2, labels = "",cex= 1, clockwise = TRUE, main = "Internet",
    col = "chocolate4" )
   
legend("topleft",paste(c("SI"),
                          label),
       cex = 0.9, 
       fill = "chocolate4")
```
